...
<!-- 活期类账户 -->
  <div>
    ...
    >
      ...
      <el-table-column align="center"  prop="address" label="序号" ></el-table-column>
       <el-table-column align="center"  prop="address" label="委托方简称" ></el-table-column>
      <el-table-column align="center"  prop="address" label="委托方账户全称" ></el-table-column>
      <el-table-column align="center"  prop="address" label="委托方编号" ></el-table-column>
      
      <el-table-column align="center"  prop="address" label="委托方账号" ></el-table-column>
