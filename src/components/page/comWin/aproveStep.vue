<template>
  <el-dialog title="审核详情" :visible.sync="visible" >
    <el-table
    ...
    >
      ...
      <el-table-column align="center"  prop="address" label="执行结果" ></el-table-column>
      <el-table-column align="center"  prop="address" label="反馈详情" ></el-table-column>
    </el-table>
