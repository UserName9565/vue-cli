      ...
      <el-card>
        ...
        <el-form :model="model"  ref="ruleForm" label-width="130px" v-show="tabActive =='userInfo'">
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <el-form-item label="金额(元)" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="存入日期" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <el-form-item label="到期日" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="计息天数(天)" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <el-form-item label="收益计算方式" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
             <el-col :span="8">
