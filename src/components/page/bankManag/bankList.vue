<template>
  <div class="mod-role container">
    ...
    >
      ...
      <el-table-column prop="address" label="交易对手" ></el-table-column>
      <el-table-column prop="address" label="金融机构" ></el-table-column>
      
      <el-table-column prop="address" label="鼓动关系" ></el-table-column>
