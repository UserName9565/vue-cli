  ...
  <div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column align="center" prop="name" label="审核"></el-table-column>
        <el-table-column align="center" prop="address" label="编号"></el-table-column>
        <el-table-column align="center" prop="address" label="投资主体"></el-table-column>
        <el-table-column align="center" prop="address" label="投委会纪要"></el-table-column>

        <el-table-column align="center" type="index" label="投资形式"></el-table-column>
        <el-table-column align="center" prop="date" label="发行银行"></el-table-column>
        <el-table-column align="center" prop="name" label="规模（元）"></el-table-column>
        ...
        <el-table-column align="center" type="index" label="投资天数"></el-table-column>
        <el-table-column align="center" prop="date" label="产品类型"></el-table-column>
        <el-table-column align="center" prop="name" label="风险级别"></el-table-column>
        <el-table-column align="center" prop="address" label="合同签订日期"></el-table-column>
        <el-table-column align="center" prop="address" label="合同编号"></el-table-column>
        <el-table-column align="center" prop="address" label="产品名称"></el-table-column>

        <el-table-column align="center" type="index" label="产品编码"></el-table-column>
        <el-table-column align="center" prop="date" label="募集期开始日"></el-table-column>
        <el-table-column align="center" prop="name" label="募集期到期日"></el-table-column>
        <el-table-column align="center" prop="address" label="募集期利息"></el-table-column>
        <el-table-column align="center" prop="address" label="兑付期开始日"></el-table-column>
        <el-table-column align="center" prop="address" label="兑付期到期日"></el-table-column>

        <el-table-column align="center" type="index" label="兑付期利息"></el-table-column>
        <el-table-column align="center" prop="date" label="是否到期"></el-table-column>
        <el-table-column align="center" prop="name" label="资金到账日"></el-table-column>
        <el-table-column align="center" prop="address" label="到期收益"></el-table-column>
        <el-table-column align="center" prop="address" label="收益匡算（元）"></el-table-column>
