...
<div class="container">
  <el-tabs v-model="tabActive" @tab-click="handleTabClick">
    ...
    >
      ...
      <el-table-column align="center"  prop="name" label="存单简称" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="存单全称" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="交易对手" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="面值总计（元）" width="180"></el-table-column>
      <el-table-column align="center"  prop="date" label="发行价格（元）" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="利率（%）" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="缴款日" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="起息日" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="到期日" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="期限（天）" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="实际缴款金额（元）" width="180"></el-table-column>
    ...
    <div class="table-title"  style="margin-top:20px">
      ...
      <el-table-column align="center"  prop="address" label="缴款日" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="起息日" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="到期日" width="180"></el-table-column>
      <el-table-column align="center"  prop="date" label="期限（天）" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="实际缴款金额（元）" width="180"></el-table-column> 
        <el-table-column align="center"  fixed="left" label="操作" width="130">
          <template slot-scope="scope">
            <el-button @click="doDel(scope.row)" type="text" size="mini">删除</el-button>
