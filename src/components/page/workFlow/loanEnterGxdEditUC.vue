  ...
  <el-row :gutter="20">
    ...
    <el-col :span="8">
      <el-form-item label="婚姻状况" prop="maritalStatusId" verify class="is-required">
        <t-dic-select dicType="public_maritalstatus" v-model="headerEntity.maritalStatusId"></t-dic-select>
      </el-form-item>
    </el-col>
  </el-row>
  <el-row :gutter="20">
    <el-col :span="8">
      <el-form-item label="学历" prop="educationalLevel" verify class="is-required">
        <t-dic-select dicType="public_educationallevel" v-model="headerEntity.educationalLevel"></t-dic-select>
      </el-form-item>
    </el-col>
    <el-col :span="8">
    ...
    <el-col :span="8">
      <el-form-item label="职务" prop="jobId" verify class="is-required">
        <t-dic-select dicType="pl_loanenter_job" v-model="headerEntity.jobId"></t-dic-select>
      </el-form-item>
    </el-col>
  </el-row>
  <el-row :gutter="20">
    ...
    <el-col :span="8">
      <el-form-item label="居住情况" prop="residentialStatusId" verify class="is-required">
        <t-dic-select dicType="pl_loanenter_residentialstatus" v-model="headerEntity.residentialStatusId"></t-dic-select>
      </el-form-item>
    </el-col>
  </el-row>
  <el-row :gutter="20">
    ...
    <el-col :span="8">
      <el-form-item label="业务来源" prop="businessSourceId" verify class="is-required">
        <t-dic-select dicType="pl_loanenter_businesssource" v-model="headerEntity.businessSourceId"></t-dic-select>
      </el-form-item>
    </el-col>
  </el-row>
  <el-row :gutter="20">
  ...
  <el-row :gutter="20">
    ...
    <el-col :span="8">
      <el-form-item label="还款方式" prop="returnMoneyMethodId" verify class="is-required">
        <t-dic-select dicType="pl_returnmoneymethod" v-model="headerEntity.returnMoneyMethodId"></t-dic-select>
      </el-form-item>
    </el-col>
  </el-row>
  <el-row :gutter="20">
    ...
    <el-col :span="8">
      <el-form-item label="资金来源" prop="fundsSourceId" verify class="is-required">
        <t-dic-select dicType="pl_loanenter_fundssource" v-model="headerEntity.fundsSourceId"></t-dic-select>
      </el-form-item>
    </el-col>
  </el-row>
  <el-row :gutter="20">
