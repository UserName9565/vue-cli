...
<el-dialog width="80%" :title="formAction == 0 ? '新增数据' : '修改数据'" :close-on-click-modal="false" :visible.sync="visible">
      ...
      <el-card>
        ...
        <span>业务信息：</span>
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="交易类型" prop="loginId" verify  :maxLength="50" class="is-required">
                <el-input  ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="交易规模(亿)" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
           ...
           <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="交易日期" prop="loginId" verify  :maxLength="50" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
       ...
       <el-card>
        ...
        <el-form :model="model"  ref="ruleForm" label-width="130px" v-show="tabActive =='userInfo'">
          <el-row :gutter="10">
            ...
            <el-col :span="8">
              <el-form-item label="基金简称" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="产品类型" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="转换基金代码" prop="loginId" verify  :maxLength="50" class="is-required">
                <el-input  ></el-input>
              </el-form-item>
            </el-col>
      ...
      <el-card>
        ...
        <el-form :model="model"  ref="ruleForm" label-width="130px" v-show="tabActive =='userInfo'">
          ...
          <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="原转换基金代码" prop="loginId" verify  :maxLength="50" class="is-required">
                <el-input  ></el-input>
              </el-form-item>
            </el-col>
