  ...
  <div>
    ...
    <el-card>
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column align="center" type="index" label="编码"></el-table-column>
        <el-table-column align="center" prop="date" label="规模(元)"></el-table-column>
        <el-table-column align="center" prop="name" label="数据日期"></el-table-column>
        ...
        <el-table-column align="center" prop="address" label="投资起始日"></el-table-column>
        <el-table-column align="center" prop="address" label="业务编码"></el-table-column>
