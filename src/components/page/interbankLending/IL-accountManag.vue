  ...
  <div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column align="center" prop="name" label="审核状态"></el-table-column>
        <el-table-column align="center" prop="address" label="业务编号"></el-table-column>
        <el-table-column align="center" prop="address" label="成交日期"></el-table-column>
        <el-table-column align="center" prop="address" label="业务品种"></el-table-column>
        <el-table-column align="center" type="index" label="交易方向"></el-table-column>
        <el-table-column align="center" prop="date" label="交易对手"></el-table-column>
        <el-table-column align="center" prop="name" label="金额*（亿元）"></el-table-column>
        <el-table-column align="center" prop="address" label="利率*（%）"></el-table-column>
        <el-table-column align="center" prop="address" label="加点（bp）"></el-table-column>
        <el-table-column align="center" prop="address" label="期限*（天数）"></el-table-column>
        <el-table-column align="center" type="index" label="交易品种*"></el-table-column>
        <el-table-column align="center" prop="date" label="首次结算日*"></el-table-column>
        <el-table-column align="center" prop="name" label="到期结算日*"></el-table-column>
        <el-table-column align="center" prop="address" label="实际占款天数*"></el-table-column>
        <el-table-column align="center" prop="address" label="成交单编号*"></el-table-column>
        <el-table-column align="center" prop="address" label="应计利息（元）"></el-table-column>
        <el-table-column align="center" type="index" label="业务状态*"></el-table-column>
        <el-table-column align="center" prop="date" label="实际首次结算日期*"></el-table-column>
        <el-table-column align="center" prop="name" label="实际到期结算日期*"></el-table-column>
        <el-table-column align="center" prop="address" label="是否到期"></el-table-column>
        <el-table-column align="center" prop="address" label="超额收益（万元）"></el-table-column> 
