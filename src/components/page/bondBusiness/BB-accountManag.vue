  ...
  <div>
    ...
    <el-card>
      ...
      <el-table-column align="center" type="index" label="操作人"></el-table-column>
        ...
        <el-table-column align="center" prop="name" label="债券简称"></el-table-column>
        <el-table-column align="center" prop="address" label="投资规模（元）"></el-table-column>
        <el-table-column align="center" prop="address" label="票面利率(%)"></el-table-column>
        <el-table-column align="center" prop="address" label="承销商"></el-table-column>
        <el-table-column align="center" type="index" label="发行人"></el-table-column>
        <el-table-column align="center" prop="date" label="主体评级"></el-table-column>
        <el-table-column align="center" prop="name" label="债项评级"></el-table-column>
        <el-table-column align="center" prop="address" label="申购日"></el-table-column>
        ...
        <el-table-column align="center" type="index" label="债券期限（天）"></el-table-column>
        <el-table-column align="center" prop="date" label="合同签订日期"></el-table-column>
        <el-table-column align="center" prop="name" label="合同编号"></el-table-column>
        ...
        <el-table-column align="center" prop="address" label="返还费率（%）"></el-table-column>
        <el-table-column align="center" prop="address" label="返还费金额（元）"></el-table-column>
...
export default {
  ...
  methods: {
    doNew() {
      this.$router.push("BB-addBusinessPlanManag");
