...
<div class="container">
  <el-tabs v-model="tabActive" @tab-click="handleTabClick">
    <el-tab-pane label="业务方案" name="userInfo">
      ...
      style="width: 100%"
    >
      <el-table-column align="center"  prop="date" label="编号" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="债券简称" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="债券全称" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="申购日" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="申购规模(元)" width="180"></el-table-column>
      <el-table-column align="center"  prop="date" label="申购利率(%)" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="承销商" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="发行人" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="主体评级" width="180"></el-table-column>
      <el-table-column align="center"  prop="address" label="债项评级" width="180"></el-table-column>
      <el-table-column align="center"  prop="date" label="起息日" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="到期日" width="180"></el-table-column>
      <el-table-column align="center"  prop="name" label="债券期限(天)" width="180"></el-table-column>
    ...
    <el-tab-pane label="方案审批表" name="orgin">
       ...
       <h3 class="table-title">同业存单审批表（【】年第【】期）</h3>
       <el-table
      :data="tableData3"  :header-cell-style="{background:'#e0f3ff',color:'#5f95b7'}"
      border
      stripe
   ...
   <el-dialog title="导入报价数据" :visible.sync="priceVisible">
     <el-card class="box-card">
      ...
      <div v-for="o in 4" :key="o" :class="{active:o==heightNu}" class="text itemList" @click="heightLine(o)">
        {{'列表内容 ' + o }}
      </div>
    </el-card>
