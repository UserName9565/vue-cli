  ...
  <el-tabs v-model="tabActive" @tab-click="handleTabClick" tab-position="right" class="fixed-header">
    ...
    <el-tab-pane label="咨询附件" name="assetManagement">
      <div style="margin-bottom:20px;">
        <base-asset-management ref="assetManagement" :assetCategoryClassifications="['pl_loanapplyInput']" :businessDocId="docId" v-if="tabActive =='assetManagement'" :disabled="true">
        </base-asset-management>
      </div>
    </el-tab-pane>
    <el-tab-pane label="积分卡" name="loanAuditScore">
      <base-asset-management ref="loanAuditScore" :assetCategory="'pl_loanauditscore_category'" :businessDocId="docId" v-if="tabActive =='loanAuditScore'">
      </base-asset-management>
    </el-tab-pane>
