...
<div>
  <el-tabs v-model="tabActive" @tab-click="handleTabClick" tab-position="right" class="fixed-header">
    ...
    <el-tab-pane label="附件" name="assetManagement">
      <div style="margin-bottom:20px;">
        <base-asset-management ref="assetManagement" :assetCategoryClassifications="assetCategoryClassifications" :businessDocId="docId" v-if="tabActive =='assetManagement'">
