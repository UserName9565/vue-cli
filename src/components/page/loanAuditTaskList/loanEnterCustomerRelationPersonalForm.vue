    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-form-item label="婚姻状况" prop="personalMaritalStatusId" verify class="is-required">
          <t-dic-select dicType="public_maritalstatus" v-model="model.personalMaritalStatusId"></t-dic-select>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-form-item label="性别" prop="personalSexId" verify class="is-required">
          <t-dic-select dicType="public_sex" v-model="model.personalSexId"></t-dic-select>
        </el-form-item>
      </el-col>
    </el-row>
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-form-item label="学历" prop="personalEducationalLevel" verify can-be-empty>
          <t-dic-select dicType="public_educationallevel" v-model="model.personalEducationalLevel"></t-dic-select>
        </el-form-item>
      </el-col>
      <el-col :span="8">
    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <el-form-item label="职务" prop="personalJobId" verify can-be-empty>
          <t-dic-select dicType="pl_loanenter_job" v-model="model.personalJobId"></t-dic-select>
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="关联关系" prop="relationCategoryId" verify class="is-required">
          <t-dic-select dicType="pl_loanenter_customerrelation_relationcategory" v-model="model.relationCategoryId"></t-dic-select>
        </el-form-item>
      </el-col>
      <el-col :span="8"> 
      </el-col>
