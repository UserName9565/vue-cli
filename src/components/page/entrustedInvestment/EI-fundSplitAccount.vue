  ...
  <div>
    ...
    <el-card>
      ...
      >
        ...
        <el-table-column align="center" prop="address" label="总规模(元)"></el-table-column>
        <el-table-column align="center" prop="address" label="到期收益(元)"></el-table-column>
        <el-table-column align="center" prop="address" label="资金到账日"></el-table-column>
        <el-table-column align="center" prop="address" label="分账业务(笔)"></el-table-column>
        ...
        <el-table-column align="center" fixed="left" label="操作" width="180">
          <template slot-scope="scope">
            <el-button @click="doEdit(scope.row)" type="text" size="mini">分账</el-button>
            <el-button @click="doEdit(scope.row)" type="text" size="mini">明细</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
import EditForm from "./EI-accountApprovalWin/edit";
export default {
  data() {
    return {
