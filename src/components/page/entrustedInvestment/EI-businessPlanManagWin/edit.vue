       ...
       <el-card>
        ...
        <span>投资信息</span>
          ...
          <el-form label-width="130px"  :model="model1">
            <el-row :gutter="10">
            <el-col :span="8">
              <el-form-item label="委托方" prop="loginId" verify  :maxLength="50" class="is-required">
                <el-input  ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="手续费率" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
                <el-input  type="password" ></el-input>
              </el-form-item>
            </el-col>
