...
<!-- 委托方框架协议 -->
  <div>
    ...
    <el-table :data="tableData3"  :header-cell-style="{background:'#e0f3ff',color:'#5f95b7'}" border stripe highlight-current-row="true" style="width: 100%">
      ...
      <el-table-column align="center"  prop="name" label="委托方简称"></el-table-column>
      <el-table-column align="center"  prop="address" label="委托方账号"></el-table-column>
      <el-table-column align="center"  prop="address" label="框架协议编号"></el-table-column>
      <el-table-column align="center"  prop="address" label="手续费率(%)"></el-table-column>
...
<script>
import EditForm from "./EI-frameworkAgreementWin/edit";
