<template>
  <el-dialog  title="查看" :close-on-click-modal="false" :visible.sync="visible">
    ...
    <el-form :model="model"  ref="form" label-width="130px" v-show="tabActive =='userInfo'">
            ...
            <el-form-item label="委托方简称" prop="loginId" verify  :maxLength="50" class="is-required">
              <el-input v-model="model.loginId" ></el-input>
            </el-form-item>
        
            <el-form-item label="委托方账号" prop="loginPassword" v-if="formAction == 0 " :maxLength="128" :verify="validateLoginPassword" class="is-required">
              <el-input v-model="model.loginPassword" type="password" ></el-input>
            </el-form-item>
         
        
            <el-form-item label="框架协议编号" prop="name" verify  :maxLength="50" class="is-required">
              <el-input v-model="model.name" ></el-input>
            </el-form-item>
           
            <el-form-item label="手续费率(%)" prop="email" verify  can-be-empty :maxLength="45">
