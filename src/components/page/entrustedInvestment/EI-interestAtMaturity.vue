...
<!-- 业务操作 -->
  <div>
    ...
    <el-table :data="tableData3"  :header-cell-style="{background:'#e0f3ff',color:'#5f95b7'}" border stripe highlight-current-row="true" style="width: 100%">
      ...
      <el-table-column align="center"  prop="address" label="到期财务公司请三日"></el-table-column>
      <el-table-column align="center"  prop="address" label="到期补息天数"></el-table-column>
      <el-table-column align="center"  prop="address" label="到期补息利息"></el-table-column>
...
<script>
import EditForm from "./EI-interestAtMaturityWin/edit";
